    ...
    return (
        <>
            ...
            <SectionBlock theRef={techRef} title={values.tech}>
                <p>After a year of experimenting with preprocessors, this was my first website preprocessed with <a href='https://pugjs.org/api/getting-started.html'>Pug</a> <abbr className='amp' title='and'>&amp;</abbr> <a href='https://sass-lang.com/'>Sass</a>, as well as my first fully-responsive site. The experience of transitioning from &ldquo;learning&rdquo; to &ldquo;applying&rdquo; is always&nbsp;exciting.</p>
                <p>The website's design was wireframed using <a href='http://macaw.co/'>Macaw</a>, while the underlying responsive framework uses the <a href='https://www.bourbon.io/'>Bourbon</a> <abbr className='amp' title='and'>&amp;</abbr> <a href='https://neat.bourbon.io/'>Neat</a> Sass libraries. The interactive map uses the <a href='https://cloud.google.com/maps-platform/'>Google Maps Platform</a> while fonts and icons use <a href='https://fonts.google.com/'>Google Fonts</a> and <a href='https://fontawesome.com/'>Font Awesome</a>&nbsp;respectively.</p>
