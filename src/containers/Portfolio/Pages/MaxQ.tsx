    ...
    return (
        <>
            <SectionBlock theRef={infoRef} title={values.info}>
                <p>Founded in Vancouver, Canada by Kerry <abbr className='amp' title='and'>&amp;</abbr> Janet McLuhan, Max Q Live is developing technology and establishing global connections using the internet as its platform. Max Q Live is supported primarily by Fortune 500 companies and non-profits dedicated to changing the world. They hope to create a global social network that connects people from around the world in a face-to-face manner, promoting a spirit of wanderlust and adventure while teaching about the issues people face around the&nbsp;globe.</p>
            </SectionBlock>
            <SectionBlock theRef={techRef} title={values.tech}>
                <p>As the sole web developer at Max Q Live for the duration of my stay, my tasks covered all areas of the web stack from design to front-end to back-end to general IT. The primary goal was to develop a demo website that could be shown to investors. The website comprised hundreds of pages designed in Adobe Photoshop and written mainly in HTML, CSS, and <a href='https://jquery.com/'>jQuery</a>, with portions of PHP added to enable templating and speed up&nbsp;production.</p>
                <p>Server management was also an occasional part of my job, managing a Linux/Apache/MySQL/PHP &#40;LAMP&#41; server and writing a few Bash scripts to streamline common maintenance tasks. Networking between servers, computers, and video cameras was also often necessary &#40;along with some video editing&#41; since the development of video streaming software is one focus of the&nbsp;company.</p>
