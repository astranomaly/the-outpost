    ...
    return (
        <>
            <SectionBlock theRef={infoRef} title={values.info}>
                ...
                <p>Having redesigned my portfolio, the next logical step was a full rebranding. The Outpost represents both my love for travel <And/> the outdoors, as well as the decentralized nature of the internet. No matter who or where you are, you have a space for yourself&nbsp;online.</p>
            </SectionBlock>
            <SectionBlock theRef={techRef} title={values.tech}>
                <p>The redesign process was, as always, a great opportunity to experiment with the new technologies I was learning. In this case, it was an opportunity to step away from <a href='https://reactjs.org/'>React</a> tutorials and build a React app completely on my own. I also continued deepening my knowledge of <a href='https://www.typescriptlang.org/'>TypeScript</a>, learning how to integrate <abbr>TS</abbr> with React for truly modular, safely typed&nbsp;code.</p>
                ...
                <p>Images on the site are in <abbr>SVG</abbr> or <abbr>WEBP</abbr> formats where possible for reduced file sizes in modern browsers, allowing faster load times and less data use on mobile devices. Accessible Rich Internet Application (<abbr>ARIA</abbr>) tags and roles were used in as many areas as possible to aid in accessibility, along with typical HTML5&nbsp;semantics.</p>
